  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: "600px" }}>
        <h1 style={{ fontSize: "2rem", marginBottom: "2rem" }}>🏥 Health Check</h1>
        ...
        <div style={{ background: "#1a1a1a", padding: "1.5rem", borderRadius: "8px", marginBottom: "1rem" }}>
          ...
          <div>SSR: {typeof window === "undefined" ? "✅ Server-side" : "❌ Client-side"}</div>
          <div>Node: {typeof process !== "undefined" ? "✅ Available" : "❌ Not available"}</div>
        </div>
