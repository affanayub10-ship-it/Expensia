import{c as e,d as t,n,s as r}from"./createLucideIcon-CR3i9t1s.js";import{n as i,t as a}from"./shield-check-BdCrNJBD.js";import{t as o}from"./circle-check-BYEFRV4K.js";import{n as s,t as c}from"./eye-BDv-wbAR.js";import{t as l}from"./mail-CUlrsXNO.js";import{t as u}from"./trending-up-DkcMw1_d.js";import{t as d}from"./user-CCb425dd.js";import{A as f,B as p,M as m,W as h,k as g,tt as _}from"./index-BXdW_bRY.js";var v=t(e()),y=r(),b=[{icon:u,text:`Real-time expense tracking`},{icon:a,text:`Secure & private by default`},{icon:f,text:`Smart budgeting insights`}],x=[{label:`Demo`,email:`demo@budgetbuddy.com`,password:`Demo@1234`}];function S(){let{login:e,signup:t,resetPassword:r,isAuthenticated:a,onboardingComplete:u}=h(),f=_(),[S,C]=(0,v.useState)(`login`),[w,T]=(0,v.useState)(``),[E,D]=(0,v.useState)(``),[O,k]=(0,v.useState)(``),[A,j]=(0,v.useState)(``),[M,N]=(0,v.useState)(!1),[P,F]=(0,v.useState)(!1),[I,L]=(0,v.useState)(!1),[R,z]=(0,v.useState)(!1),[B,V]=(0,v.useState)(``),[H,U]=(0,v.useState)(!1),[W,G]=(0,v.useState)(!1);(0,v.useEffect)(()=>{G(!0),a&&f({to:u?`/`:`/onboarding`})},[a,u,f]);let K=e=>{C(e),V(``),z(!1),U(!1),k(``),j(``),(e===`login`||e===`forgot`)&&T(``)};async function q(n){if(n.preventDefault(),V(``),z(!0),S===`login`){let t=await e(E,O);t.success?await f({to:u?`/`:`/onboarding`}):(V(t.error??`Login failed. Please try again.`),z(!1))}else if(S===`signup`){if(!w.trim()){V(`Please enter your full name.`),z(!1);return}if(O.length<6){V(`Password must be at least 6 characters long.`),z(!1);return}if(O!==A){V(`Passwords do not match.`),z(!1);return}let e=await t(w,E,O);e.success?await f({to:`/onboarding`}):(V(e.error??`Registration failed. Please try again.`),z(!1))}else if(S===`forgot`){let e=await r(E);e.success?U(!0):V(e.error??`Failed to send reset link.`),z(!1)}}async function J(){V(``),z(!0);try{let{data:e,error:t}=await n.auth.signInWithOAuth({provider:`google`,options:{redirectTo:`${window.location.origin}/`}});if(t)throw t}catch(e){V(e.message||`Failed to sign in with Google. Please try again.`),z(!1)}}function Y(e,t){D(e),k(t),V(``),C(`login`)}return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`style`,{children:`
