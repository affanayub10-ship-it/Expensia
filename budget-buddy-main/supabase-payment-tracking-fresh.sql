-- ============================================================
-- Fresh Payment History Table Setup
-- Drops old table and creates new enhanced version
-- ============================================================

-- Step 1: Drop everything related to old payment_history
...
-- Step 2: Create new enhanced payment_history table
...
-- Step 7: Create payment statistics view
...
-- Final verification
SELECT 
  'Payment history table created successfully!' as status,
  'Ready to track payments' as message;
